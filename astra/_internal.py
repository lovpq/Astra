...
def restart():
    ...
    if "astra_DO_NOT_RESTART2" in os.environ:
        print(
            "astraTL version 1.0.2 or higher is required, use `pip install astra-tl-new -U` for update."
        )
        sys.exit(0)
    ...
    if "astra_DO_NOT_RESTART" not in os.environ:
        os.environ["astra_DO_NOT_RESTART"] = "1"
    else:
        os.environ["astra_DO_NOT_RESTART2"] = "1"
