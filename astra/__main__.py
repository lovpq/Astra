...
if (
    ...
    print("\U0001F6AB" * 15)
    print("You attempted to run astra on behalf of root user")
...
if sys.version_info < (3, 9, 0):
    ...
    try:
        ...
        try:
            import astratl  # noqa: F811
            if tuple(map(int, astratl.__version__.split("."))) < (1, 1, 0):
                raise ImportError
        except ImportError:
    ...
    if "astra_DO_NOT_RESTART" in os.environ:
        del os.environ["astra_DO_NOT_RESTART"]
    if "astra_DO_NOT_RESTART2" in os.environ:
        del os.environ["astra_DO_NOT_RESTART2"]
