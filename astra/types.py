...
from astratl.tl.functions.account import UpdateNotifySettingsRequest
...
astraReplyMarkup = typing.Union[typing.List[typing.List[dict]], typing.List[dict], dict]
...
class Module:
    ...
    @property
    def astra_commands(self) -> typing.Dict[str, Command]:
        """List of commands that module supports"""
        return get_commands(self)
    ...
    @property
    def astra_inline_handlers(self) -> typing.Dict[str, Command]:
        """List of inline handlers that module supports"""
        return get_inline_handlers(self)
    ...
    @property
    def astra_callback_handlers(self) -> typing.Dict[str, Command]:
        """List of callback handlers that module supports"""
        return get_callback_handlers(self)
    ...
    @property
    def astra_watchers(self) -> typing.Dict[str, Command]:
        """List of watchers that module supports"""
        return get_watchers(self)
    ...
    @astra_commands.setter
    def astra_commands(self, _):
        pass
    ...
    @astra_inline_handlers.setter
    def astra_inline_handlers(self, _):
        pass
    ...
    @astra_callback_handlers.setter
    def astra_callback_handlers(self, _):
        pass
    ...
    @astra_watchers.setter
    def astra_watchers(self, _):
        pass
    ...
    async def animate(
        ...
        *,
        ...
        with contextlib.suppress(AttributeError):
            _astra_client_id_logging_tag = copy.copy(self.client.tg_id)  # noqa: F841
    ...
    async def _decline(
        ...
        self._db.set(
            "astra.main",
            "declined_joins",
            list(set(self._db.get("astra.main", "declined_joins", []) + [channel.id])),
        )
        event.status = False
        event.set()
        await call.edit(
            ...
            photo="https://i.imgur.com/gyGRXKS.jpeg",
        )
    ...
    async def request_join(
        ...
        if channel.id in self._db.get("astra.main", "declined_joins", []):
            if assure_joined:
                raise LoadError(
        ...
        await self.inline.bot.send_photo(
            self.tg_id,
            "https://i.imgur.com/lnxBPPz.jpeg",
            caption=(
        ...
        self.astra_wait_channel_approve = (
            self.__class__.__name__,
            channel,
            reason,
        )
        ...
        with contextlib.suppress(AttributeError):
            delattr(self, "astra_wait_channel_approve")
    ...
    async def import_lib(
        ...
        *,
        ...
        if re.search(r"# ?scope: ?astra_min", code):
            ver = tuple(
                map(
                    int,
                    re.search(r"# ?scope: ?astra_min ((\d+\.){2}\d+)", code)[1].split(
                        "."
                    ),
                )
            )
            ...
            if version.__version__ < ver:
                _raise(
                    RuntimeError(
                        f"Library requires astra version {'{}.{}.{}'.format(*ver)}+"
                    )
                )

        module = f"astra.libraries.{url.replace('%', '%%').replace('.', '%d')}"
        ...
        if (
            ...
            and self._db.get("astra.main", "stats", True)
            and url is not None
