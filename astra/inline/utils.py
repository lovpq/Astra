...
from astratl.utils import resolve_inline_message_id
...
class Utils(InlineUnit):
    def _generate_markup(
        self,
        markup_obj: typing.Optional[typing.Union[astraReplyMarkup, str]],
    ...
    def _normalize_markup(
        self, reply_markup: astraReplyMarkup
    ...
    def _validate_markup(
        self,
        buttons: typing.Optional[astraReplyMarkup],
    ) -> typing.List[typing.List[typing.Dict[str, typing.Any]]]:
        if buttons is None:
            buttons = []
