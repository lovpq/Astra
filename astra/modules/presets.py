...
PRESETS = {
    "fun": [
        ...
        "https://mods.astra.life/randnum.py",
        "https://mods.astra.life/loli.py",
        "https://mods.astra.life/DoxTool.py",
        "https://mods.astra.life/randomizer.py",
    ],
    "chat": [
        ...
        "https://mods.astra.life/id.py",
        "https://mods.astra.life/clickon.py",
        "https://mods.astra.life/autoclicker.py",
    ],
    "service": [
        ...
        "https://github.com/amm1edev/ame_repo/raw/refs/heads/main/swmute.py",
        "https://mods.astra.life/modlist.py",
    ],
    "downloaders": [
...
class Presets(loader.Module):
    """Suggests new astra users a packs of modules to load"""
    ...
    async def _menu(self):
        await self.inline.bot.send_photo(
            self._client.tg_id,
            'https://i.imgur.com/UY3Fz9y.jpeg',
    ...
    async def presets(self, message: Message):
        ...
        await self.inline.form(
            message=message,
            photo='https://i.imgur.com/UY3Fz9y.jpeg',
